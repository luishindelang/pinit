...
2. Markup: Kopfzeile mit Fassung und Werkzeugleiste · Reiterleiste `#tabs` · Zeichenfläche
   ...
   Zustand je Betrachter unter `rb.sec.<id>`, leere Abschnitte versteckt `sektionenAufraeumen()`; seit 2.33 nie höher als die Fläche, scrollt innen, Breite am Griff ziehbar und in `rb.insp.w` gemerkt):
